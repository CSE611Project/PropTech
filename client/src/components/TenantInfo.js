        ...
        <TableContainer component={Paper}>
          ...
          <TableHead>
            <TableRow>
              ...
              <TableCell />
              <TableCell><Meters className="display_item" property_id={this.state.property_id} info={this} /></TableCell>
              <TableCell><AddTenant className="display_item" property_id={this.state.property_id} info={this} /></TableCell>
            </TableRow>
            </TableHead>
            <TableBody>
            {this.res}
