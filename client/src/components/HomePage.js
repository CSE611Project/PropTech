          ...
          <Paper elevation={24}>
            ...
            <div className="buttons">
              <table>
                <td>
                  <Paper >
                    <Button color="primary" style={{fontSize: 15}} className="button" onClick={login}>Login</Button>
                  </Paper>
                </td>
                <td>
                  <Paper>
                    <Button color="primary" style={{fontSize: 15}} className="button" onClick={signup}>Sign Up</Button>
                  </Paper>
                </td>
              </table>
            </div>
