...
class RUBS extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            yes: false,
            no: false,
            totalBuildingFt: '1000', //replace this by real ftage
            tenantFt: ''
        }
    ...
    calculate(event) {
        console.log("teanant fotage: ", this.state.tenantFt);
        console.log("rubs: ", this.state.tenantFt/this.state.totalBuildingFt *100 +"%");
        {/* should specify a way to calculate rubs based on tenantFt and then save into rubs variable*/}
        var rubs = this.state.tenantFt/this.state.totalBuildingFt;
        this.setState({
            rubs: rubs
        })
    }
        ...
        return (
            <div>
                <FormControl>
                    <FormLabel>
                        <table>
                            <td>Is there a RUBS?</td>
                            <td><WhatIsProRataShare /></td>
                        </table>
                    </FormLabel>
                    <FormGroup row>
                        <FormControlLabel
                        ...
                        {isNo
                            ? <div>
                                ...
                                <TextField
                                    ...
                                    fullWidth
                                />
                                <Button onClick={this.calculate} color="primary">Calculate</Button>
                            </div>
                            : null
                        }
                    </div>
