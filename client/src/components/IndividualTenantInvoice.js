...
class IndividualTenantInvoice extends Component {
  constructor(props) {
    ...
    console.log(this.state.tenant_list, this.state.invoice_list, this.state.property_id);
    this.getTenantList();
  }
  componentDidMount() {
...
//////////////////////////////////////////////////
    var matrix = [];
    var tenant_list_temp = this.state.tenant_list;
    var tenant_list_size = tenant_list_temp.length;
    console.log("tenant list temp", tenant_list_temp)
    console.log("property id", this.state.property_id)
