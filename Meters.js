...
class Meters extends React.Component{
    ...
    addMeter(user_id, properity_info){
        {/*axios.post('/properity', {user_id: this.state.user_id, property_info: properity_info}).then(response => {
            ...
            for (var i = 0; i < tableData.length; i++) {
                res.push(
                    ...
                    <tr key={i} id={i}>
                        ...
                        <td><EditMeters
                            properity_id = {tableData[i].property_id}
                            name={tableData[i].name}
                            address={tableData[i].address}
                            meter = {tableData[i].meter}
            ...
            <div>
                ...
                <Dialog open={this.state.open} onClose={this.handleClose} aria-labelledby="form-dialog-title">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>192962</td>
                            <td><EditMeters submeter="192962" /></td>
                            <td><DeleteMeters submeter="192962" /></td>
                            <td><MeterBillPage submeter="192962"/></td>
                        </tr>
                    </table>
                    <DialogContent>
                        <DialogContentText>
